...
import './ColoredProductCard.css';
import explore222 from '../Assets/data';

const ColoredProductCard = (props) => {
  ...
  return (
    <div className="carddiv">
      ...
      <div className="productdetails">
        ...
        <button className="coloredbtn1" style={{background:props.color1}}></button>
        <button className="coloredbtn2" style={{background:props.color2}}></button>
...
// Default props
ColoredProductCard.defaultProps = {
  salepersent: "Sale",
  salebg: "#db4444",
  new_price: "0.00",
  stars: 3,
...
export default ColoredProductCard;